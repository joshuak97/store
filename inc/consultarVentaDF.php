...
echo '<tr><td>'.$prods['codProd'].'</td><td>'.$prods['nombreProd']." ".$prods['NombreMarca'].'</td><td><input type="number" min="0" max="'.$cant[$u].'" onchange="cantidadDev('.$u.',this);" onkeyup="cantidadDev('.$u.',this);" onclick="cantidadDev('.$u.',this);" value="0"></td></tr>';	
}
}
echo '</table><br>';
echo '<div class=" text-center"> 
<button class="btn btn-success btn-sm" id="realizarDev" onclick="addDevolucionDF();">Devolver por fallos</button>
