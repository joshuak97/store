...
$prod=array();
$cant=array();
$consultaVenta=ejecutarSQL::consultar("SELECT descripcionDF FROM devoluciones_por_fallas where idDevolucionFalla=".$_POST['recipient']);
...
$productos=explode(" ",$venta['descripcionDF']);
