...
if(uso!="NO"){    
$.ajax({
 url: "factura_digital/ejemplo_timbradoCredito.php",
 type: 'post',
 data:uso,
 beforeSend: function(){
...
//Funcion que se activa al cerrar modal cliente:
$(document).ready(function(){
    ...
    <section id="container-pedido">
        <div class="container">
            ...
            <div class="row">
                ...
                <br><h3 class="text-center">Uso de factura:</h3><br>
                    <div id="form-venta">
