    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
       ...
       <br>
		...
		<td style="width:25%;" class="midnight-blue">VENDEDOR</td>
			...
			<td style="width:25%;" class="midnight-blue">PROXIMO PAGO</td>
		...
		<tr>
		  ...
		  <td style="width:25%;" >
				<?php
				$proximo=str_replace("-","/",$_SESSION['proximoAbono']);
				$proximoA=str_split($proximo);
				$proximoAbono=$proximoA[8].$proximoA[9].$proximoA[4].$proximoA[5].$proximoA[6].$proximoA[7].$proximoA[0].$proximoA[1].$proximoA[2].$proximoA[3];
				echo $proximoAbono;
...
$sql=mysqli_query($con, "SELECT * from producto inner join marca on producto.idMarca=marca.idMarca where codProd='".$_SESSION['producto'][$u]."'");
...
?>
		...
		<?php
		$restante=$total_factura-$_SESSION['abonoV'];	
		?>
		<tr>
            <td colspan="3" style="width: 85%; text-align: right;">ABONO <?php echo "$";?> </td>
            <td style="width: 15%; text-align: right;"> <?php echo number_format($_SESSION['abonoV'],2);?></td>
		</tr><tr>
            <td colspan="3" style="width: 85%; text-align: right;">RESTANTE <?php echo "$";?> </td>
            <td style="width: 15%; text-align: right;"> <?php echo number_format($restante,2);?></td>
        </tr>
