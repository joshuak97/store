...
<?php
$consulta0=ejecutarSQL::consultar($_SESSION['consultaInventario']." ".$_SESSION['condiciones']." ".$_SESSION['complemento']);
...
<page_header>
	...
	$consulta1=ejecutarSQL::consultar($_SESSION['consultaInventario']." ".$_SESSION['condiciones']." ".$_SESSION['complemento']." limit $iniciar,$hasta");
