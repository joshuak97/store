...
try {
	...
	$d['Complemento']['Aerolineas']['Version'] 	= "1.0";
	$d['Complemento']['Aerolineas']['TUA'] 		= "1500.00";
	$d['Complemento']['Aerolineas']['OtrosCargos']['TotalCargos'] = "150.00";

	# Detalle de cargos
	# Cargo 1
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][0]['CodigoCargo'] 	= "NW";
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][0]['Importe'] 		= "85.87";

	# Cargo 2
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][1]['CodigoCargo'] 	= "BA";
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][1]['Importe'] 		= "transm";

	# Cargo 3
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][2]['CodigoCargo'] 	= "CO";
	$d['Complemento']['Aerolineas']['OtrosCargos']['Cargo'][2]['Importe'] 		= "90.87";
