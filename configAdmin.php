...
//Metodo que visualiza la lista de productos añadidos al cerrar el modal agregar productos 
...
//lista de carros al eliminar modelos en modal añadir productos
...
//Boton añadir modelos en boton añadir productos 
...
//Boton añadir equivalencias en modal editar productos:
...
$('#buscarProds').click(function(){
 ...
             <h1>Panel de administración <small class="tittles-pages-logo">Store EWS
				</small></h1>
            </div>
            <!-- Nav tabs -->
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-product">
							...
							<div class="form-group">
                                ...
                                <input type="text" class="form-control"  placeholder="Código" required  name="prod-codigo" id="codProds" onkeyup="verificarCodigoProducto(this);">
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <textarea class="form-control"  placeholder="Descripción" required name="prod-des" rows="10" cols="40"></textarea>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">                                 
                                 &nbsp<input type="button" value="Añadir Nuevo Proveedor" data-toggle="modal" data-target="#proveedorPopup" >
                              ...
                              <div class="form-group">
                                 ...
                                 &nbsp<input type="button" value="Añadir Nueva Marca" data-toggle="modal" data-target="#marcaPopup">
                              ...
                              <div class="form-group">
                                 ...
                                 &nbsp<input type="button" value="Añadir Nueva Categoria" data-toggle="modal" data-target="#categoriaPopup">
                 ...
                 <!-- Modal agregar nuevo Proveedor -->
                  ...
                  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="dir-proveedor" placeholder="Dirección proveedor" required="">
                                </div>
                                <div class="form-group">
                                    <label>Correo</label>
                                    <input class="form-control" type="text" name="correo-proveedor" placeholder="Correo Electrónico" required="">
                                </div>
                                <div class="form-group">
                                    <label>Teléfono</label>
                                    <input class="form-control" type="number" name="tel-proveedor" placeholder="Número telefónico" pattern="[0-9]{1,20}" maxlength="20" required="">
                                </div>
                                <div class="form-group">
                                    <label>Página web</label>
                                    <input class="form-control" type="text" name="web-proveedor" placeholder="Página web proveedor" required="">
                                </div>
                  </div>                
                  <div class="modal-footer">
 ...
 <!-- Modal agregar nueva nota -->
    ...
    <!-- Modal agregar nueva categoria -->
     ...
     <!-- Modal agregar nueva Marca -->
                  ...
                  <div class="form-group">
                                        <label>Código</label>
                                        <input class="form-control" type="text" name="marca-codigo" placeholder="Código de Marca" maxlength="9" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre</label>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                ...
                                <div class="form-group">
                                    <label>Correo</label>
                                    <input class="form-control" type="text" name="prove-correo" placeholder="Correo Electrónico"  maxlength="50" required="">
                                </div>
                                <div class="form-group">
                                    <label>Teléfono</label>
                                    <input class="form-control" type="number" name="prove-tel" placeholder="Número telefónico" pattern="[0-9]{1,20}" maxlength="20" required="">
                                </div>
                                <div class="form-group">
                                    <label>Página web</label>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-categori">
                                ...
                                <form action="process/regcategori.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Código</label>
                                        <input class="form-control" type="text" name="marca-code" placeholder="Código de Marca" maxlength="9" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre</label>
...
<h4 class="modal-title text-center text-success" id="myModalLabel">Consultar Entradas por producto</h4>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="addUbicacion" style="border: 1px solid #e0e1e1 !important;border-radius: 4px;padding: 10px;">
                            ...
                            <form action="process/regubicacion.php" method="post" role="form">
                                ...
                                <p class="text-center"><button type="submit" class="btn btn-primary">Añadir Ubicacion</button></p>
                                <br>
    ...
    <!-- Modal agregar nuevo cliente -->
        ...
        <!-- Modal productos -->
                  ...
                  <div class="form-group">
                                <label>Código de producto</label>
                                <input type="text" class="form-control"  placeholder="Código" required  name="prod-codigo" id="codProdsM" onkeyup="verificarCodigoProductoM(this);">
                              </div>
